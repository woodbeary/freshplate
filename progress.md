...
- ✅ How It Works page
- ✅ Pricing page
- ✅ Removed dark mode for simplified UI
- ✅ Enhanced recipe generator UI/UX
  - Single view layout
...
## Recent Improvements
- 🔄 UI/UX Enhancements
  - Removed dark mode for cleaner look
  - Implemented step-based questionnaire
  - Added location-aware recipe context
  - Improved mobile responsiveness
  - Enhanced loading states and animations
  - Organized recipe details in accordions
  - Added support for personal details in multi-serving recipes

- 🔄 Technical Updates
  - Refactored recipe generator component
...
- 🎯 Direct access to recipe generator
...
- Integration of local context and seasonality